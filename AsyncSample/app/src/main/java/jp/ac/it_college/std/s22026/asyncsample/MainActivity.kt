package jp.ac.it_college.std.s22026.asyncsample
...
import jp.ac.it_college.std.s22026.asyncsample.databinding.ActivityMainBinding
    ...
    private class WeatherInfoBackgroundReceiver(val urlString: String): Callable<String> {
        ...
        override fun call(): String {
            ...
            return try {
                ...
                さらに、InputReader を使って1行ずつ読み取って全て1つの文字列に組み立てる
